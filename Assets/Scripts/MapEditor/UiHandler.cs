...
namespace MapEditor
{
    ...
    public class UiHandler : MonoBehaviour
    {
        ...
        [SerializeField] private MapEditor.GridManager gridManager;
        ...
        [SerializeField] private UI.NotificationManager notificationManager;
        ...
        public void ToggleCanonDirection()
        {
            ...
            List<Objects.Canon> activeObjectsCanons = gridManager.GetActiveTraps().Where(t => t is Objects.Canon).Select(t => (Objects.Canon)t).ToList();
            foreach (Objects.Canon canon in activeObjectsCanons)
            {
                canon.canonType = gridManager.currentCanonDirection;
                canon.UpdateCanon();
            }
        ...
        public void ToggleAxeDirection()
        {
            ...
            List<Objects.Axe> activeObjectsAxes = gridManager.GetActiveTraps().Where(t => t is Objects.Axe).Select(t => (Objects.Axe)t).ToList();
            foreach (Objects.Axe axe in activeObjectsAxes)
            {
                axe.axeDirection = gridManager.currentAxeDirection;
                axe.SetDirection(axe.axeDirection);
            }
