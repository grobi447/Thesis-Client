    ...
    public class GridManager : MonoBehaviour
    {
        ...
        public void UpdateColliders()
        {
            for (int z = 0; z < 2; z++)
            {
                ...
                {
                    if (z == currentLayer)
                        tile.GetComponent<Objects.Tile>().TurnOnCollider();
                    else
                        tile.GetComponent<Objects.Tile>().TurnOffCollider();
                }
            }
        }
        ...
        public void ReplaceToTrap(Objects.SpriteData trapData, Vector3 position)
        {
        ...
        public void ReplaceToTile(SpriteData blockData, Vector3 position)
        {
            ...
            if (tiles.TryGetValue(position, out Tile oldTile))
            {
                ...
                Objects.Tile newTile = Instantiate(tilePrefab, position, Quaternion.identity, parent);
